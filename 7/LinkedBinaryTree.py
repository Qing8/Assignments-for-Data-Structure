...
# This class is used for Level Order tree traversal, levelorderPrint(self) at line 314.
# This class is not that useful in this assignment.
class LinkedQueue:        
...
class LinkedBinaryTree():
    ...
    def is_height_balanced(self):
        '''
        return True if the tree is height balanced, or False otherwise.
        for every node within this tree, the height of this node’s left child, height of this node’s right child, 
        differ by no more than 1.
        @return: True/False
        '''
        # Problem 1
#        pass
        return self.is_height_balanced2(self.root())
    
    def is_height_balanced2(self,root):
        
        if self.height(root) == 2:
            return True
        else:
            if self.height(self.left(root)) - self.height(self.right(root)) < -1 or self.height(self.left(root)) - self.height(self.right(root)) > 1:
                return False
            else:
                return self.is_height_balanced2(self.left(root)) and self.is_height_balanced2(self.right(root))
                
        

    def sameSame(self, other):
        '''
        @other: another LinkedBinaryTree object.
        ...
        # Problem 2
#        pass
        return self.samesame2(other,self.root(),other.root())
            
    def samesame2(self,other,selfroot,otherroot):
        if selfroot == None and otherroot == None:
            return True
        
        else:
            
            if self.left(selfroot) == None:
                if other.left(otherroot) == None:
                    return self.samesame2(other,self.right(selfroot),other.right(otherroot))
                else:
                    return False
            if self.right(selfroot) == None:
                if other.right(otherroot) == None:
                    return self.samesame2(other,self.left(selfroot),other.left(otherroot))
                else:
                    return False
            
            
            if self.left(selfroot).element()== other.left(otherroot).element() \
            and self.right(selfroot).element() == other.right(otherroot).element():
                return self.samesame2(other,self.left(selfroot),other.left(otherroot)) \
            and self.samesame2(other,self.right(selfroot),other.right(otherroot))
    ...
    def sum_of_leaves(self):
        '''
        return the sum of leaf nodes within self LinkedBinaryTree.
...
#        pass
    ...
    def find_leaves(self,current):
            if current == None:
                return 0
            if self.is_leaf(current):
                return current.element() 
            else:
                return self.find_leaves(self.left(current)) + self.find_leaves(self.right(current))
    ...
    def evaluate(self):
        '''
        evaluates the numeric result of self expression tree (LinkedBinaryTree).
        You can assume my tests are valid expression trees.
        @return: float number
        '''
        # Problem 5
#        pass
        ...
        order = []
        self.postorder(self.root(),order)
        for i in order:
            if type(i)==int:
                stack.append(i)
            else:
    ...
    def postorder(self,root,result):
        ...
        return result.append(root.element())


def build_expression_tree(postfix):
    '''
    @postfix: postfix string
    construct a expression tree for postfix input, using an instance of LinkedBinaryTree object.
    @return: a LinkedBinaryTree object.
    '''
    # Problem 4
#    pass
    l = postfix.split()
    ...
    for i in ll:
        if type(i) == int:
            integer_tree = LinkedBinaryTree()
            integer_tree.add_root(i)
            stack.append(integer_tree)
        else:
            ele2 = stack.pop(-1)
            ele1 = stack.pop(-1)
            t = LinkedBinaryTree()
            root_pos = t.add_root(i)
            t.attach(root_pos, ele1, ele2)
            stack.append(t)
    return stack.pop(-1)
...
################### Again, to test on Gradescope, comment out test code ####################
##########################################################
## Test case booleans, flip to True to enable testing
#is_height_balanced_test = False
#sameSame_test = True
...
#        print("Testing problem 1.......: is the tree height balanced?")
...
#
#    if (sameSame_test):
#        print("Testing problem 2.......: Same Tree")
...
#        print("Testing problem 3.......: Sum of leaves")
#        print(T.sum_of_leaves(), "    Expected result is 21")
#
#
#    if (build_expression_tree_test):
#        print("Testing problem 4.......: Expression Tree")
...
#
#    if (evaluate_test):
#        print("Testing problem 5.......: Evaluating Expression Tree")
